...
public class EmailService {
    ...
    public void sendBookingConfirmation(
        ...
        // Email headers
        helper.setFrom("masterclasscricket.co.uk@gmail.com");
        helper.setTo("samuelvullangula16@gmail.com");
        helper.setSubject("✅ Booking Confirmation - Masterclass Cricket Academy");

        // Determine programme based on year
        String programme = "";
        ...
        // Build session details and clean up null values
